    ...
    <Event
      ...
      params={{
        ordered: [
          ...
          {
            fileName:
              "DISNEY_REORDER_COLOR_RAW_{{moment(new Date()).format('YYYY-MM-DD')}}_{{ current_user.fullName }}",
          },
        ],
      }}
      pluginId=""
    ...
    <Event
      ...
      params={{
        ordered: [
          ...
          {
            fileName:
              "DISNEY_REORDER_SIZE_RAW_{{moment(new Date()).format('YYYY-MM-DD')}}_{{ current_user.fullName }}",
          },
        ],
      }}
      pluginId=""
