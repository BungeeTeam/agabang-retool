<ExpandedRow id="prev_sales_tableExpandedRow">
  <Table
    id="prev_middle_cat_table"
  ...
  const result = currentSourceRow.large_cat === '총계' ? data : 
  currentSourceRow.large_cat.slice(-2) === '소계' ? data.filter(i =>i.cat_group === currentSourceRow.cat_group): 
