...
const groupKeys = ["large_cat"];

// [수정] 초기 그룹핑 시, 유지해야 할 모든 키를 포함
const initialGroupKeys = ["year_nm","cat_group", "year_cd","season_nm", ...groupKeys];
...
const subtotalConfigs = [
  { 
    name: "정상소계",
    categories: ["시즌의류", "시즌언더", "시즌용품"],
    cat_group: "정상"// 정상소계는 의류/용품을 모두 포함하므로
  },
  { 
    name: "기획소계",
    categories: ["기획의류", "기획언더"],
    cat_group: "기획"
...
const allSubtotals = createSubtotals({
  ...
  sumKeys: sumKeys // 모든 소계에 공통으로 들어갈 값
});
