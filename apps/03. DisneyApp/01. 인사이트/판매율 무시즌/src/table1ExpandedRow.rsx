<ExpandedRow id="table1ExpandedRow">
  <Table
    id="table5"
    autoColumnWidth={true}
    cellSelection="none"
    clearChangesetOnSave={true}
    data="{{ currentSourceRow.cat_id === 777 ? [...(var_middle_cat.value.var_01[57] || []),
  ...(var_middle_cat.value.var_01[56] || []),
  ...(var_middle_cat.value.var_01[62] || []) ]
  : currentSourceRow.cat_id === 888 ? [...(var_middle_cat.value.var_01[59]||[]),...(var_middle_cat.value.var_01[60]||[])]
  : currentSourceRow.cat_id === 999 ? [...(var_middle_cat.value.var_01[57] || []),
  ...(var_middle_cat.value.var_01[56] || []),
  ...(var_middle_cat.value.var_01[62] || []),
  ...(var_middle_cat.value.var_01[59] || []),
  ...(var_middle_cat.value.var_01[60] || []) ]
  : var_middle_cat.value.var_01[currentSourceRow.cat_id] }}"
