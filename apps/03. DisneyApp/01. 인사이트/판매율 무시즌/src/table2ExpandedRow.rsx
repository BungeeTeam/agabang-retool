<ExpandedRow id="table2ExpandedRow">
  <Table
    ...
    data="{{ currentSourceRow.cat_id === 777 ? [...(var_middle_cat.value.var_02[57] || []),
  ...(var_middle_cat.value.var_02[56] || []),
  ...(var_middle_cat.value.var_02[62] || []) ]
  : currentSourceRow.cat_id === 888 ? [...(var_middle_cat.value.var_02[59]||[]),...(var_middle_cat.value.var_02[60]||[])]
  : currentSourceRow.cat_id === 999 ? [...(var_middle_cat.value.var_02[57] || []),
  ...(var_middle_cat.value.var_02[56] || []),
  ...(var_middle_cat.value.var_02[62] || []),
  ...(var_middle_cat.value.var_02[59] || []),
  ...(var_middle_cat.value.var_02[60] || []) ]
  : var_middle_cat.value.var_02[currentSourceRow.cat_id] }}"
