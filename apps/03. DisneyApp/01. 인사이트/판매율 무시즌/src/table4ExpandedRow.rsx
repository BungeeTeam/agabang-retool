<ExpandedRow id="table4ExpandedRow">
  <Table
    ...
    data="{{ currentSourceRow.cat_id === 777 ? [...(var_middle_cat.value.var_04[57] || []),
  ...(var_middle_cat.value.var_04[56] || []),
  ...(var_middle_cat.value.var_04[62] || []) ]
  : currentSourceRow.cat_id === 888 ? [...(var_middle_cat.value.var_04[59]||[]),...(var_middle_cat.value.var_04[60]||[])]
  : currentSourceRow.cat_id === 999 ? [...(var_middle_cat.value.var_04[57] || []),
  ...(var_middle_cat.value.var_04[56] || []),
  ...(var_middle_cat.value.var_04[62] || []),
  ...(var_middle_cat.value.var_04[59] || []),
  ...(var_middle_cat.value.var_04[60] || []) ]
