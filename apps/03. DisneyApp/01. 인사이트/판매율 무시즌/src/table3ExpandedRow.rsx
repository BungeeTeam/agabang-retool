<ExpandedRow id="table3ExpandedRow">
  <Table
    id="table7"
    autoColumnWidth={true}
    cellSelection="none"
    clearChangesetOnSave={true}
    data="{{ currentSourceRow.cat_id === 777 ? [...(var_middle_cat.value.var_03[57] || []),
  ...(var_middle_cat.value.var_03[56] || []),
  ...(var_middle_cat.value.var_03[62] || []) ]
  : currentSourceRow.cat_id === 888 ? [...(var_middle_cat.value.var_03[59]||[]),...(var_middle_cat.value.var_03[60]||[])]
  : currentSourceRow.cat_id === 999 ? [...(var_middle_cat.value.var_03[57] || []),
  ...(var_middle_cat.value.var_03[56] || []),
  ...(var_middle_cat.value.var_03[62] || []),
  ...(var_middle_cat.value.var_03[59] || []),
  ...(var_middle_cat.value.var_03[60] || []) ]
  : var_middle_cat.value.var_03[currentSourceRow.cat_id] }}"
  ...
  >
    ...
    <Event
      ...
      params={{
        ordered: [
          {
            src: "let _year_cd='Q0'\nswitch(moment().subtract('2', 'years').format('YY')){\n  case '32': { _year_cd = 'Z0' } break;\n  case '31': { _year_cd = 'Y0' } break;\n  case '30': { _year_cd = 'X0' } break;\n  case '29': { _year_cd = 'W0' } break;\n  case '28': { _year_cd = 'V0' } break;\n  case '27': { _year_cd = 'U0' } break;\n  case '26': { _year_cd = 'T0' } break;\n  case '25': { _year_cd = 'S0' } break;\n  case '24': { _year_cd = 'R0' } break;\n  case '23': { _year_cd = 'Q0' } break;\n  case '22': { _year_cd = 'P0' } break;\n  case '21': { _year_cd = 'O0' } break;\n  case '20': { _year_cd = 'N0' } break;\n  case '19': { _year_cd = 'M0' } break;\n}\nvar_clicked_middle_cat.setValue(\n  {\n    cat_id: currentSourceRow.cat_id,\n    middle_cat:  currentSourceRow.middle_cat ,\n    start_dt:'2000-01-01',\n    end_dt: date_select.value,\n    year_cd: _year_cd,\n    year_sesn_nm:  moment().year(),\n    cat_nm: currentSourceRow.cat_nm\n  }\n)\nawait get_item_status.trigger()\nmodal_item_list.show()",
          },
        ],
      }}
      pluginId=""
