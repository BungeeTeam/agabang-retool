...
return data"
  ...
  />
  <SqlQuery
    id="query_get_data_channel_new"
    enableTransformer={true}
    errorTransformer="// The variable 'data' allows you to reference the request's data in the transformer. 
// example: return data.find(element => element.isError)
return data.error"
    isMultiplayerEdited={false}
    query={include("./lib/query_get_data_channel_new.sql", "string")}
    resourceDisplayName="clickhouse-dw"
    resourceName="46922e5d-5645-4057-8fc8-3cc8cb9fbfe4"
    transformer="// Query results are available as the `data` variable
return data"
...
return data"
  ...
  <State
    ...
    value={
      '[\n  { cat_nm: "시즌의류", id: 57, item_code: 2 },\n  { cat_nm: "시즌언더", id: 56, item_code: 1 },\n  { cat_nm: "시즌용품", id: 62, item_code: 7 },\n]'
    }
  />
  <Function
    id="var_channel_data_list"
    funcBody={include("./lib/var_channel_data_list.js", "string")}
  />
  <SqlQuery
    id="query_shop_list_new"
    isMultiplayerEdited={false}
    query={include("./lib/query_shop_list_new.sql", "string")}
    resourceDisplayName="clickhouse-dw"
    resourceName="46922e5d-5645-4057-8fc8-3cc8cb9fbfe4"
    runWhenModelUpdates={false}
    warningCodes={[]}
  />
  <SqlQuery
    id="query_channel_list_new"
    enableTransformer={true}
    isMultiplayerEdited={false}
    query={include("./lib/query_channel_list_new.sql", "string")}
    resourceDisplayName="clickhouse-dw"
    resourceName="46922e5d-5645-4057-8fc8-3cc8cb9fbfe4"
    runWhenModelUpdates={false}
    showSuccessToaster={false}
...
const result = Data.map(i=>i.year_season_cd)
