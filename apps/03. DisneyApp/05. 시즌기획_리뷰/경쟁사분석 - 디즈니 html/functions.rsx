...
return data"
  ...
  <State
    ...
    persistValue={false}
    value={
      '["블루독베이비", "밍크뮤", "압소바", "타티네 쇼콜라", "해피랜드", "베베드피노", "베베드피노 언더웨어", "모이몰른", "모이몰른 US", "디즈니"]'
    }
  />
  <JavascriptQuery
    id="set_brand_list"
