...
try {
  ...
  const desiredHeaders = ['품번','품평번호','품평점수','품평등급','품평의견', '소재','성별','대분류','중분류','소분류','예상TAG가(원)','확정TAG가(원)','디자이너','MD제안납기','확정납기','색상','기획량','사전원가(v-,원)','확정원가(v-,원)'];
  const columnIndices = {};
...
//    const headerRow = jsonData[headerRowIndex];
//    const desiredHeaders = ['품번','품평번호','품평점수','품평등급','품평의견', '소재','성별','대분류','중분류','소분류','예상TAG가(원)','확정TAG가(원)','디자이너','MD제안납기','확정납기','색상','기획량'];
//    const columnIndices = {};
