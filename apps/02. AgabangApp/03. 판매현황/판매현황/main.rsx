        ...
        <View id="a7c37" viewKey="View 1">
          ...
          >
            ...
            <Column
              ...
              formatOptions={{ showSeparators: true, notation: "standard" }}
              groupAggregationMode="average"
              hidden="{{ !var_item_list.value[listView_main.item][var_item_list.value[listView_main.item]?.length-1].sale_per_100X130 }}"
            ...
            <Column
              ...
              formatOptions={{ showSeparators: true, notation: "standard" }}
              groupAggregationMode="average"
              hidden="{{ !var_item_list.value[listView_main.item][var_item_list.value[listView_main.item]?.length-1].sale_per_105X135 }}"
            ...
            <Column
              ...
              formatOptions={{ showSeparators: true, notation: "standard" }}
              groupAggregationMode="average"
              hidden="{{ !var_item_list.value[listView_main.item][var_item_list.value[listView_main.item]?.length-1].sale_per_115X145 }}"
            ...
            <Column
              ...
              formatOptions={{ showSeparators: true, notation: "standard" }}
              groupAggregationMode="average"
              hidden="{{ !var_item_list.value[listView_main.item][0].sale_per_44 }}"
              key="sale_per_44"
              label="44"
              placeholder="Enter value"
              position="center"
                  ...
                  ordered: [
                    {
                      options: {
                        ordered: [
                          ...
                          {
                            fileName:
                              "아가방 {{select_season.selectedLabel }} 판매현황",
                          },
                        ],
                      },
                    },
