...
--     SELECT id, cat_nm
--     FROM agabang_dw.retooldb_item_md_category 
--     WHERE id = {{sel_category.value}}
--     LIMIT 1
-- ),
STY_SEASON AS (
SELECT
...
--   82,6M,80
  ...
  -- 위 새로 추가 -------
   ...
   -- new -- 31,100,30
    ...
    -- sum(case when (A.size_seq = 1 and A.size_tp='10' and A.size_cd='10') then sale_qty
    --          when (A.size_seq = 1 and A.size_tp='11' and A.size_cd='13') then sale_qty
    --          when (A.size_seq = 1 and A.size_tp='20' and A.size_cd='20') then sale_qty
    --          when (A.size_seq = 1 and A.size_tp='22' and A.size_cd='13') then sale_qty
    --          when (A.size_seq = 1 and A.size_tp='40' and A.size_cd='36') then sale_qty
    --          when (A.size_seq = 1 and A.size_tp='50' and A.size_cd='51') then sale_qty
    --          else 0 end) as sale_qty_01,
    -- max(case when (A.size_seq = 1 and A.size_tp='10' and A.size_cd='10') then tot_in_qty
    --          when (A.size_seq = 1 and A.size_tp='11' and A.size_cd='13') then tot_in_qty
    --          when (A.size_seq = 1 and A.size_tp='20' and A.size_cd='20') then tot_in_qty
    --          when (A.size_seq = 1 and A.size_tp='22' and A.size_cd='13') then tot_in_qty
    --          when (A.size_seq = 1 and A.size_tp='40' and A.size_cd='36') then tot_in_qty
    --          when (A.size_seq = 1 and A.size_tp='50' and A.size_cd='51') then tot_in_qty
    --          else 0 end) as tot_in_qty_01,
    -- max(case when (A.size_seq = 1 and A.size_tp='10' and A.size_cd='10') then size_nm
    --          when (A.size_seq = 1 and A.size_tp='11' and A.size_cd='13') then size_nm
    --          when (A.size_seq = 1 and A.size_tp='20' and A.size_cd='20') then size_nm
    --          when (A.size_seq = 1 and A.size_tp='22' and A.size_cd='13') then size_nm
    --          when (A.size_seq = 1 and A.size_tp='40' and A.size_cd='36') then size_nm
    --          when (A.size_seq = 1 and A.size_tp='50' and A.size_cd='51') then size_nm
    --          else null end) as size_nm_01,

    -- sum(case when (A.size_seq = 2 and A.size_tp='11' and A.size_cd='14') then sale_qty
    --          when (A.size_seq = 2 and A.size_tp='20' and A.size_cd='21') then sale_qty
    --          when (A.size_seq = 2 and A.size_tp='22' and A.size_cd='14') then sale_qty
    --          when (A.size_seq = 2 and A.size_tp='40' and A.size_cd='37') then sale_qty
    --          when (A.size_seq = 2 and A.size_tp='50' and A.size_cd='52') then sale_qty
    --          else 0 end) as sale_qty_02,
    -- max(case when (A.size_seq = 2 and A.size_tp='11' and A.size_cd='14') then tot_in_qty
    --          when (A.size_seq = 2 and A.size_tp='20' and A.size_cd='21') then tot_in_qty
    --          when (A.size_seq = 2 and A.size_tp='22' and A.size_cd='14') then tot_in_qty
    --          when (A.size_seq = 2 and A.size_tp='40' and A.size_cd='37') then tot_in_qty
    --          when (A.size_seq = 2 and A.size_tp='50' and A.size_cd='52') then tot_in_qty
    --          else 0 end) as tot_in_qty_02,
    -- max(case when (A.size_seq = 2 and A.size_tp='11' and A.size_cd='14') then size_nm
    --          when (A.size_seq = 2 and A.size_tp='20' and A.size_cd='21') then size_nm
    --          when (A.size_seq = 2 and A.size_tp='22' and A.size_cd='14') then size_nm
    --          when (A.size_seq = 2 and A.size_tp='40' and A.size_cd='37') then size_nm
    --          when (A.size_seq = 2 and A.size_tp='50' and A.size_cd='52') then size_nm
    --          else null end) as size_nm_02,

    -- sum(case when A.size_seq = 3 and A.size_tp='20' and A.size_cd='22' then sale_qty
    --          when A.size_seq = 3 and A.size_tp='30' and A.size_cd='33' then sale_qty
    --          when A.size_seq = 3 and A.size_tp='40' and A.size_cd='38' then sale_qty
    --          when A.size_seq = 3 and A.size_tp='50' and A.size_cd='53' then sale_qty
    --          when A.size_seq = 3 and A.size_tp='70' and A.size_cd='72' then sale_qty
    --          else 0 end) as sale_qty_03,
    -- max(case when A.size_seq = 3 and A.size_tp='20' and A.size_cd='22' then tot_in_qty
    --          when A.size_seq = 3 and A.size_tp='30' and A.size_cd='33' then tot_in_qty
    --          when A.size_seq = 3 and A.size_tp='40' and A.size_cd='38' then tot_in_qty
    --          when A.size_seq = 3 and A.size_tp='50' and A.size_cd='53' then tot_in_qty
    --          when A.size_seq = 3 and A.size_tp='70' and A.size_cd='72' then tot_in_qty
    --          else 0 end) as tot_in_qty_03,
    -- max(case when A.size_seq = 3 and A.size_tp='20' and A.size_cd='22' then size_nm
    --          when A.size_seq = 3 and A.size_tp='30' and A.size_cd='33' then size_nm
    --          when A.size_seq = 3 and A.size_tp='40' and A.size_cd='38' then size_nm
    --          when A.size_seq = 3 and A.size_tp='50' and A.size_cd='53' then size_nm
    --          when A.size_seq = 3 and A.size_tp='70' and A.size_cd='72' then size_nm
    --          else null end) as size_nm_03,

    -- sum(case when A.size_seq = 4 and A.size_tp='10' and A.size_cd='13' then sale_qty
    --          when A.size_seq = 4 and A.size_tp='11' and A.size_cd='16' then sale_qty
    --          when A.size_seq = 4 and A.size_tp='22' and A.size_cd='16' then sale_qty
    --          when A.size_seq = 4 and A.size_tp='50' and A.size_cd='54' then sale_qty
    --          when A.size_seq = 4 and A.size_tp='60' and A.size_cd='63' then sale_qty
    --          when A.size_seq = 4 and A.size_tp='70' and A.size_cd='73' then sale_qty
    --          else 0 end) as sale_qty_04,
    -- max(case when A.size_seq = 4 and A.size_tp='10' and A.size_cd='13' then tot_in_qty
    --          when A.size_seq = 4 and A.size_tp='11' and A.size_cd='16' then tot_in_qty
    --          when A.size_seq = 4 and A.size_tp='22' and A.size_cd='16' then tot_in_qty
    --          when A.size_seq = 4 and A.size_tp='50' and A.size_cd='54' then tot_in_qty
    --          when A.size_seq = 4 and A.size_tp='60' and A.size_cd='63' then tot_in_qty
    --          when A.size_seq = 4 and A.size_tp='70' and A.size_cd='73' then tot_in_qty
    --          else 0 end) as tot_in_qty_04,
    -- max(case when A.size_seq = 4 and A.size_tp='10' and A.size_cd='13' then size_nm
    --          when A.size_seq = 4 and A.size_tp='11' and A.size_cd='16' then size_nm
    --          when A.size_seq = 4 and A.size_tp='22' and A.size_cd='16' then size_nm
    --          when A.size_seq = 4 and A.size_tp='50' and A.size_cd='54' then size_nm
    --          when A.size_seq = 4 and A.size_tp='60' and A.size_cd='63' then size_nm
    --          when A.size_seq = 4 and A.size_tp='70' and A.size_cd='73' then size_nm
    --          else null end) as size_nm_04,

    -- sum(case when A.size_seq = 5 and A.size_tp='10' and A.size_cd='14' then sale_qty
    --          when A.size_seq = 5 and A.size_tp='30' and A.size_cd='35' then sale_qty
    --          when A.size_seq = 5 and A.size_tp='40' and A.size_cd='40' then sale_qty
    --          when A.size_seq = 5 and A.size_tp='60' and A.size_cd='64' then sale_qty
    --          else 0 end) as sale_qty_05,
    -- max(case when A.size_seq = 5 and A.size_tp='10' and A.size_cd='14' then tot_in_qty
    --          when A.size_seq = 5 and A.size_tp='30' and A.size_cd='35' then tot_in_qty
    --          when A.size_seq = 5 and A.size_tp='40' and A.size_cd='40' then tot_in_qty
    --          when A.size_seq = 5 and A.size_tp='60' and A.size_cd='64' then tot_in_qty
    --          else 0 end) as tot_in_qty_05,
    -- max(case when A.size_seq = 5 and A.size_tp='10' and A.size_cd='14' then size_nm
    --          when A.size_seq = 5 and A.size_tp='30' and A.size_cd='35' then size_nm
    --          when A.size_seq = 5 and A.size_tp='40' and A.size_cd='40' then size_nm
    --          when A.size_seq = 5 and A.size_tp='60' and A.size_cd='64' then size_nm
    --          else null end) as size_nm_05,

    -- sum(case when A.size_seq = 6 and A.size_tp='11' and A.size_cd='20' then sale_qty
    --          when A.size_seq = 6 and A.size_tp='22' and A.size_cd='20' then sale_qty
    --          when A.size_seq = 6 and A.size_tp='30' and A.size_cd='36' then sale_qty
    --          when A.size_seq = 6 and A.size_tp='60' and A.size_cd='65' then sale_qty
    --          else 0 end) as sale_qty_06,
    -- max(case when A.size_seq = 6 and A.size_tp='11' and A.size_cd='20' then tot_in_qty
    --          when A.size_seq = 6 and A.size_tp='22' and A.size_cd='20' then tot_in_qty
    --          when A.size_seq = 6 and A.size_tp='30' and A.size_cd='36' then tot_in_qty
    --          when A.size_seq = 6 and A.size_tp='60' and A.size_cd='65' then tot_in_qty
    --          else 0 end) as tot_in_qty_06,
    -- max(case when A.size_seq = 6 and A.size_tp='11' and A.size_cd='20' then size_nm
    --          when A.size_seq = 6 and A.size_tp='22' and A.size_cd='20' then size_nm
    --          when A.size_seq = 6 and A.size_tp='30' and A.size_cd='36' then size_nm
    --          when A.size_seq = 6 and A.size_tp='60' and A.size_cd='65' then size_nm
    --          else null end) as size_nm_06,

    -- sum(case when A.size_seq = 7 and A.size_tp='10' and A.size_cd='16' then sale_qty
    --          when A.size_seq = 7 and A.size_tp='11' and A.size_cd='21' then sale_qty
    --          when A.size_seq = 7 and A.size_tp='30' and A.size_cd='37' then sale_qty
    --          when A.size_seq = 7 and A.size_tp='40' and A.size_cd='42' then sale_qty
    --          when A.size_seq = 7 and A.size_tp='60' and A.size_cd='66' then sale_qty
    --          else 0 end) as sale_qty_07,
    -- max(case when A.size_seq = 7 and A.size_tp='10' and A.size_cd='16' then tot_in_qty
    --          when A.size_seq = 7 and A.size_tp='11' and A.size_cd='21' then tot_in_qty
    --          when A.size_seq = 7 and A.size_tp='30' and A.size_cd='37' then tot_in_qty
    --          when A.size_seq = 7 and A.size_tp='40' and A.size_cd='42' then tot_in_qty
    --          when A.size_seq = 7 and A.size_tp='60' and A.size_cd='66' then tot_in_qty
    --          else 0 end) as tot_in_qty_07,
    -- max(case when A.size_seq = 7 and A.size_tp='10' and A.size_cd='16' then size_nm
    --          when A.size_seq = 7 and A.size_tp='11' and A.size_cd='21' then size_nm
    --          when A.size_seq = 7 and A.size_tp='30' and A.size_cd='37' then size_nm
    --          when A.size_seq = 7 and A.size_tp='40' and A.size_cd='42' then size_nm
    --          when A.size_seq = 7 and A.size_tp='60' and A.size_cd='66' then size_nm
    --          else null end) as size_nm_07,

    -- sum(case when A.size_seq = 8 and A.size_tp='11' and A.size_cd='22' then sale_qty
    --          when A.size_seq = 8 and A.size_tp='22' and A.size_cd='21' then sale_qty
    --          when A.size_seq = 8 and A.size_tp='30' and A.size_cd='38' then sale_qty
    --          else 0 end) as sale_qty_08,
    -- max(case when A.size_seq = 8 and A.size_tp='11' and A.size_cd='22' then tot_in_qty
    --          when A.size_seq = 8 and A.size_tp='22' and A.size_cd='21' then tot_in_qty
    --          when A.size_seq = 8 and A.size_tp='30' and A.size_cd='38' then tot_in_qty
    --          else 0 end) as tot_in_qty_08,
    -- max(case when A.size_seq = 8 and A.size_tp='11' and A.size_cd='22' then size_nm
    --          when A.size_seq = 8 and A.size_tp='22' and A.size_cd='21' then size_nm
    --          when A.size_seq = 8 and A.size_tp='30' and A.size_cd='38' then size_nm
    --          else null end) as size_nm_08,

    -- sum(case when A.size_seq = 9 and A.size_tp='10' and A.size_cd='20' then sale_qty
    --          when A.size_seq = 9 and A.size_tp='22' and A.size_cd='22' then sale_qty
    --          else 0 end) as sale_qty_09,
    -- max(case when A.size_seq = 9 and A.size_tp='10' and A.size_cd='20' then tot_in_qty
    --          when A.size_seq = 9 and A.size_tp='22' and A.size_cd='22' then tot_in_qty
    --          else 0 end) as tot_in_qty_09,
    -- max(case when A.size_seq = 9 and A.size_tp='10' and A.size_cd='20' then size_nm
    --          when A.size_seq = 9 and A.size_tp='22' and A.size_cd='22' then size_nm
    --          else null end) as size_nm_09,

    -- sum(case when A.size_seq = 10 and A.size_tp='00' and A.size_cd='10' then sale_qty
    --          when A.size_seq = 10 and A.size_tp='10' and A.size_cd='21' then sale_qty
    --          when A.size_seq = 10 and A.size_tp='30' and A.size_cd='40' then sale_qty
    --          else 0 end) as sale_qty_10,
    -- max(case when A.size_seq = 10 and A.size_tp='00' and A.size_cd='10' then tot_in_qty
    --          when A.size_seq = 10 and A.size_tp='10' and A.size_cd='21' then tot_in_qty
    --          when A.size_seq = 10 and A.size_tp='30' and A.size_cd='40' then tot_in_qty
    --          else 0 end) as tot_in_qty_10,
    -- max(case when A.size_seq = 10 and A.size_tp='00' and A.size_cd='10' then size_nm
    --          when A.size_seq = 10 and A.size_tp='10' and A.size_cd='21' then size_nm
    --          when A.size_seq = 10 and A.size_tp='30' and A.size_cd='40' then size_nm
    --          else null end) as size_nm_10
...
SELECT
    ...
    case
      when {{sel_category.value}} = 55 then '전체'
...
-- LEFT OUTER JOIN 제거 - selected_category CTE로 대체됨
...
CASE when ({{sel_category.value ?? 0}} = 91) THEN H.item_md_category_id is null -- 복종X:91
     WHEN ({{sel_category.value ?? 0}} = 55) THEN true -- 전체:55
