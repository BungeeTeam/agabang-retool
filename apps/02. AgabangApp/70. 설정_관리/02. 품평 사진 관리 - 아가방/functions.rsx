...
return data"
  ...
  <S3Query
    ...
    uploadFileName="item_review/brand_code={{var_brand_code.value}}/{{sel_folder.value}}/{{upload_file_dropzone.value[i].name}}"
  ...
  <RESTQuery
    ...
    bodyType="json"
    notificationDuration={4.5}
    query="z__manual_update_review_image_not_ettoi/dagRuns"
