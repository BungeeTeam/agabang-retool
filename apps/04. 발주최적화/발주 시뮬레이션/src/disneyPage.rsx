...
>
  <RetoolAIQuery
    ...
    chatHistory="{{ orderOptChat3.messageHistory.slice(1, orderOptChat3.messageHistory.length) }}"
    chatInput="{{orderOptChat3.lastMessage }}"
...
- 경영진 요약, 상세 분석, 다음 단계로 명확하게 구조화된 응답"
  ...
  <SqlQuery
    ...
    isMultiplayerEdited={false}
    notificationDuration={4.5}
    query={include("../lib/ordOptQuery3.sql", "string")}
    resourceDisplayName="clickhouse-dw"
    resourceName="46922e5d-5645-4057-8fc8-3cc8cb9fbfe4"
    showSuccessToaster={false}
    ...
    warningCodes={[]}
  />
  <State id="isHidden3" value="false" />
  <Include src="./header3.rsx" />
  <Include src="./AIReviewModal3.rsx" />
  <Include src="./alertModal3.rsx" />
  <Frame
    id="$main3"
    ...
    >
      <Event
        ...
        params={{
          ordered: [
            {
              src: "if (simulTbl3.data.length === 0) {\n  alertModal3.show()\n} else {\n  AIReviewModal3.show()\n}",
            },
          ],
        }}
        pluginId=""
