let styList = {{ formatDataAsArray(styQuery.data) }}
const distData = {{ orderDistQuery.data }}
const minQty = {{ minNumberInput.value }}
const shopList = {{ shopListCombined.value }}
...
const distRatio = {{ distRatio.value }}
