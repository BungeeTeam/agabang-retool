...
>
  ...
  <Body>
    ...
    <Text
      ...
      verticalAlign="center"
    />
    <Button id="button10" margin="2px 8px" text="매장 및 수량 지정하기">
      <Event
        event="click"
        method="show"
        params={{ ordered: [] }}
    ...
    <Table
      ...
      data="{{ shopListCombined2.value.filter(obj => obj.default_qty > 0) }}"
    ...
    <Text
      id="text52"
      value="##### 초도 분배를 위한 매장 선정(총 {{ shopTbl2.data.filter(item => item.is_checked === true).length }}개)"
      verticalAlign="center"
    />
    <Text
      id="text50"
      ...
      verticalAlign="center"
    />
    <Button id="button9" margin="2px 8px" text="매장 선택 초기화">
      <Event
        event="click"
        method="run"
        params={{
    ...
    <Button id="button8" margin="2px 8px" text="지난달 매출있는 매장 추가">
      <Event
        event="click"
        method="run"
        params={{
          ordered: [
            {
              src: "await updateShopWithRevenue2.trigger()\nshopTbl2.refresh()",
            },
          ],
        }}
        pluginId=""
    ...
    >
      ...
      <Event
        ...
        params={{
          ordered: [
            {
              src: "await updateRetoolDB2.trigger()\nawait shopTbl2.refresh()",
            },
          ],
        }}
        pluginId=""
