...
return transform(data)"
  ...
  />
  <SqlQuery
    id="api_get_season_code_to_year"
    importedQueryInputs={{ ordered: [{ p_code: "{{ p_year_code }}" }] }}
    isImported={true}
    notificationDuration={4.5}
    playgroundQueryName="g_season_code_to_year"
    playgroundQueryUuid="f4caa4cf-58a6-4272-b3ce-01ea8d225982"
    query={include("./lib/api_get_season_code_to_year.sql", "string")}
    resourceDisplayName="clickhouse-dw"
    resourceName="46922e5d-5645-4057-8fc8-3cc8cb9fbfe4"
