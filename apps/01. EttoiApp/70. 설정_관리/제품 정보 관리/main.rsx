<App>
  ...
  <DocumentTitle id="$customDocumentTitle" value="제품 정보 관리 | ET" />
  ...
  >
    ...
    <Table
      ...
      data="{{ query_get_info.data.filter(item =>
  multiselect1.value.includes(item.year_season_cd)
) }}"
...
사은품으로 주로 제공되는 제품을 통계에서 제외할 수 있습니다."
      ...
      <Column
        ...
        format="string"
        groupAggregationMode="none"
        key="sample_cost_final"
        label="Sample cost final"
        placeholder="Enter value"
        position="center"
        size={100}
        summaryAggregationMode="none"
      ...
      <Column
        ...
        formatOptions={{ showSeparators: true, notation: "standard" }}
        groupAggregationMode="sum"
        key="first_cost_final"
        label="First cost final"
        placeholder="Enter value"
        position="center"
        size={100}
        summaryAggregationMode="none"
      ...
      <Column
        ...
        formatOptions={{ showSeparators: true, notation: "standard" }}
        groupAggregationMode="sum"
        key="first_cost_total_final"
        label="First cost total final"
        placeholder="Enter value"
        position="center"
        size={100}
        summaryAggregationMode="none"
            ...
            ordered: [
              {
                options: {
                  ordered: [
                    ...
                    {
                      fileName:
                        "제품 정보({{ moment().format('YYYY-MM-DD') }})",
                    },
                  ],
                },
              },
