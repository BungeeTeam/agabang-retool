...
const groupKeys = ["large_cat", "middle_cat","small_cat"]
...
const groupedArr = groupBySum(arrData, ["year_nm", "year_cd","season_nm", "total","cat_group","apparel_group", ...groupKeys], sumKeys)
  ...
  if (b.year_nm !== a.year_nm) {
    return b.year_nm - a.year_nm; // year_nm 내림차순
  }
  if (b.large_cat > a.large_cat) return 1;
  if (b.large_cat < a.large_cat) return -1;
  if (b.small_cat > a.small_cat) return 1;
  if (b.small_cat < a.small_cat) return -1;
  return 0;
});