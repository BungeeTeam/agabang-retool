WITH
  ...
  toDate('{{ comparison_basis_select.value === 'same_weekday' ? get_same_weekday_new.data.same_weekday : get_same_weekday_new.data.same_date}}') as last_year_end_dt,
...
saleTbl as (
    SELECT
        ...
        coalesce(B.large_cat,'미분류') as large_cat, B.middle_cat as middle_cat, B.small_cat as small_cat,
...
WHERE A.sty_nm != '테스트' and A.large_cat != '캔슬';
-- saleTbl as (
--     SELECT
--     B.sty_cd as sty_cd, B.sty_nm as sty_nm,
--     B.col_cd as col_cd, B.col_nm as col_nm,
