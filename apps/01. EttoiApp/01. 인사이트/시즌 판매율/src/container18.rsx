...
>
  ...
  <View id="7b13c" label="증감량" viewKey="View 1">
    <Table
      ...
      rowBackgroundColor="{{ currentSourceRow.large_cat === '총계' ? '#bebada':
   currentSourceRow.large_cat.slice(-2) === '소계'? '#ccebc5': 
  '#FFFFF'}}
...
"
    ...
    >
      <Include src="./compare_sales_tableExpandedRow.rsx" />
      <Column
        id="cb4b0"
        alignment="left"
        editable="false"
      ...
      <Column
        id="762f1"
        alignment="right"
        backgroundColor="{{ currentSourceRow.large_cat === '총계' ? '#bebada':
   currentSourceRow.large_cat.slice(-2) === '소계' && currentSourceRow.apparel_group != '시즌의류' ? '#ccebc5': 
  '#efefef'}}"
        editableOptions={{ showStepper: true }}
        format="decimal"
        formatOptions={{ showSeparators: true, notation: "standard" }}
  ...
  '#efefef'}}"
      ...
      <Column
        id="961b1"
        alignment="right"
        backgroundColor="{{ currentSourceRow.large_cat === '총계' ? '#FFED6F' : ''}}"
        editableOptions={{ showStepper: true }}
        format="percent"
        formatOptions={{
          showSeparators: true,
  ...
  '#efefef'}}"
      ...
      <Column
        ...
        alignment="right"
        backgroundColor="
{{ currentSourceRow.large_cat === '총계' ? '#FFED6F':
   currentSourceRow.large_cat.slice(-2) === '소계' && currentSourceRow.apparel_group != '시즌의류' ? '#ccebc5': 
  '#efefef'}}"
   ...
   currentSourceRow.large_cat.slice(-2) === '소계' && currentSourceRow.apparel_group != '시즌의류' ? '#ccebc5': 
    '#afd7f2'}}"
      ...
      <Column
        ...
        alignment="right"
        backgroundColor="
{{ currentSourceRow.large_cat === '총계' ? '#bebada':
   currentSourceRow.large_cat.slice(-2) === '소계' && currentSourceRow.apparel_group != '시즌의류' ? '#ccebc5': 
    '#ff9e93'}}"
        editableOptions={{ showStepper: true }}
        format="decimal"
