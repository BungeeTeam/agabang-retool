...
>
  ...
  <Body>
    ...
    <Image
      ...
      retoolFileObject=""
      src="https://agabang-image.s3.ap-northeast-2.amazonaws.com/item_final/{{var_item_info.value.sty_cd}}{{var_item_info.value.col_cd}}.jpg"
    ...
    <Spacer id="spacer7" />
    <Text id="text10" value="**사이즈별 입고/판매량**" verticalAlign="center" />
    <Spacer id="spacer10" />
    <Table
      id="table1"
      cellSelection="none"
