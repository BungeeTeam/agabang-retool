<ExpandedRow id="table1ExpandedRow">
  ...
  ? [...(var_middle_cat.value.var_01[6] || []),...(var_middle_cat.value.var_01[7]||[]),...(var_middle_cat.value.var_01[10]||[])] 
  : currentSourceRow.cat_id === 777 ? [...(var_middle_cat.value.var_01[1] || []),
  ...(var_middle_cat.value.var_01[2] || []),
  ...(var_middle_cat.value.var_01[3] || []),
  ...(var_middle_cat.value.var_01[6] || []),
  ...(var_middle_cat.value.var_01[7] || [])]
  : currentSourceRow.cat_id === 888 ? [...(var_middle_cat.value.var_01[4]||[]),...(var_middle_cat.value.var_01[5]||[])]
  : currentSourceRow.cat_id === 999 ? [...(var_middle_cat.value.var_01[1] || []),
  ...(var_middle_cat.value.var_01[2] || []),
  ...(var_middle_cat.value.var_01[3] || []),
  ...(var_middle_cat.value.var_01[4] || []),
  ...(var_middle_cat.value.var_01[5] || []),
  ...(var_middle_cat.value.var_01[6] || []),
  ...(var_middle_cat.value.var_01[7] || []),
  ...(var_middle_cat.value.var_01[8] || [])]
