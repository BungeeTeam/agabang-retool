<ExpandedRow id="table2ExpandedRow">
  ...
  ? [...(var_middle_cat.value.var_02[6] || []),...(var_middle_cat.value.var_02[7]||[]),...(var_middle_cat.value.var_02[10]||[])] 
  : currentSourceRow.cat_id === 777 ? [...(var_middle_cat.value.var_02[1] || []),
  ...(var_middle_cat.value.var_02[2] || []),
  ...(var_middle_cat.value.var_02[3] || []),
  ...(var_middle_cat.value.var_02[6] || []),
  ...(var_middle_cat.value.var_02[7] || [])]
  : currentSourceRow.cat_id === 888 ? [...(var_middle_cat.value.var_02[4]||[]),...(var_middle_cat.value.var_02[5]||[])]
  : currentSourceRow.cat_id === 999 ? [...(var_middle_cat.value.var_02[1] || []),
  ...(var_middle_cat.value.var_02[2] || []),
  ...(var_middle_cat.value.var_02[3] || []),
  ...(var_middle_cat.value.var_02[4] || []),
  ...(var_middle_cat.value.var_02[5] || []),
  ...(var_middle_cat.value.var_02[6] || []),
  ...(var_middle_cat.value.var_02[7] || []),
  ...(var_middle_cat.value.var_02[8] || [])]
