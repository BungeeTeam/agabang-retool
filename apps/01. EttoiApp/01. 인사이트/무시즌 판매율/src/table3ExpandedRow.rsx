<ExpandedRow id="table3ExpandedRow">
  ...
  ? [...(var_middle_cat.value.var_03[6] || []),...(var_middle_cat.value.var_03[7]||[]),...(var_middle_cat.value.var_03[10]||[])] 
  : currentSourceRow.cat_id === 777 ? [...(var_middle_cat.value.var_03[1] || []),
  ...(var_middle_cat.value.var_03[2] || []),
  ...(var_middle_cat.value.var_03[3] || []),
  ...(var_middle_cat.value.var_03[6] || []),
  ...(var_middle_cat.value.var_03[7] || [])]
  : currentSourceRow.cat_id === 888 ? [...(var_middle_cat.value.var_03[4]||[]),...(var_middle_cat.value.var_03[5]||[])]
  : currentSourceRow.cat_id === 999 ? [...(var_middle_cat.value.var_03[1] || []),
  ...(var_middle_cat.value.var_03[2] || []),
  ...(var_middle_cat.value.var_03[3] || []),
  ...(var_middle_cat.value.var_03[4] || []),
  ...(var_middle_cat.value.var_03[5] || []),
  ...(var_middle_cat.value.var_03[6] || []),
  ...(var_middle_cat.value.var_03[7] || []),
  ...(var_middle_cat.value.var_03[8] || [])]
