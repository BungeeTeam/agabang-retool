...
>
  <Header>
    <Text
      id="modalTitle3"
      value="#### 매장 리스트 ( {{ [selectedRow2.value.it_gb_nm, selectedRow2.value.item_nm, selectedRow2.value.br_nm,selectedRow2.value.sub_br_nm].filter(Boolean).join(' / ') }})"
  ...
  <Body>
    <Table
      ...
      data="{{ filterBySelectedRow2.value }}"
  ...
  currentSourceRow.shop_nm === '총계'? '01488F66' :'ffffff' }}"
    ...
    >
      ...
      <Column
        ...
        hidden="false"
        key="cur_qty"
        label="{{moment(dateRange5.value.start).format('YY') }}년 판매수량"
        placeholder="Enter value"
        position="center"
        size={91.828125}
      ...
      <Column
        ...
        hidden="false"
        key="cur_tag"
        label="{{moment(dateRange5.value.start).format('YY') }}년 매출 (TAG)"
        placeholder="Enter value"
        position="center"
        size={100.4375}
        summaryAggregationMode="none"
      ...
      <Column
        ...
        groupAggregationMode="sum"
        key="cur_amt"
        label="{{moment(dateRange5.value.start).format('YY') }}년 실매출"
        placeholder="Enter value"
        position="center"
        size={90.453125}
        summaryAggregationMode="none"
      ...
      <Column
        ...
        label="{{moment(dateRange5.value.start).format('YY') }}년 할인율"
        placeholder="Enter value"
        position="center"
      ...
      <Column
        ...
        hidden="false"
        key="prev_qty"
        label="{{moment(dateRange5.value.start).subtract(1,'year').format('YY') }}년 판매수량"
        placeholder="Enter value"
        position="center"
        size={106.046875}
        summaryAggregationMode="none"
      ...
      <Column
        ...
        hidden="false"
        key="prev_tag"
        label="{{moment(dateRange5.value.start).subtract(1,'year').format('YY') }}년 매출 (TAG)"
        placeholder="Enter value"
        position="center"
        size={66.140625}
        summaryAggregationMode="none"
      ...
      <Column
        ...
        groupAggregationMode="sum"
        key="prev_amt"
        label="{{moment(dateRange5.value.start).subtract(1,'year').format('YY') }}년 실매출"
        placeholder="Enter value"
        position="center"
        size={78.296875}
        summaryAggregationMode="none"
      ...
      <Column
        ...
        groupAggregationMode="average"
        label="{{moment(dateRange5.value.start).subtract(1,'year').format('YY') }}년 할인율"
        placeholder="Enter value"
        position="center"
      ...
      <Column
        ...
        key="cur_cost"
        label="{{moment(dateRange5.value.start).format('YY') }}년 원가"
        placeholder="Enter value"
        position="center"
        size={85.078125}
        summaryAggregationMode="none"
      ...
      <Column
        ...
        groupAggregationMode="average"
        hidden="{{ !switchCostOnOff.value }}"
        label="{{moment(dateRange5.value.start).format('YY') }}년 원가율"
        placeholder="Enter value"
        position="center"
      ...
      <Column
        ...
        hidden="{{ !switchCostOnOff.value }}"
        key="prev_cost"
        label="{{moment(dateRange5.value.start).subtract(1,'year').format('YY') }}년 원가"
        placeholder="Enter value"
        position="center"
        size={84.296875}
        summaryAggregationMode="none"
      ...
      <Column
        ...
        groupAggregationMode="average"
        hidden="{{ !switchCostOnOff.value }}"
        label="{{moment(dateRange5.value.start).subtract(1,'year').format('YY') }}년 원가율"
        placeholder="Enter value"
        position="center"
            ...
            ordered: [
              {
                options: {
                  ordered: [
                    ...
                    {
                      fileName:
                        "{{ modalTitle3.value.slice(5) }}_({{ dateRange5.value.start }}~{{ dateRange5.value.end }})",
                    },
                  ],
                },
              },
