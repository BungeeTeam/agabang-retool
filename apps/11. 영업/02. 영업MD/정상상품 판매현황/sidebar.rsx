  ...
  current_user.groups.map(i => i.name).includes('디즈니 부문') ? ['DS']:['A1']}}"
    ...
    >
      ...
      <Option
        ...
        hidden={false}
        parentKey="bbb313a3-baf4-4147-ab5c-fba3cc8dc620"
        value="{{ moment().format('YYYY') }}년 매출비중"
      />
      <Option
        id="40336"
        disabled={false}
        hidden={false}
        parentKey="bbb313a3-baf4-4147-ab5c-fba3cc8dc620"
        value="{{ moment().format('YYYY') }}년 할인율"
      />
      <Option
        id="40978"
        disabled={false}
        hidden={false}
        parentKey="bbb313a3-baf4-4147-ab5c-fba3cc8dc620"
        value="{{ moment().subtract(1,'years').format('YYYY') }}년 매출"
      />
      <Option
        id="dcfef"
        disabled={false}
        hidden={false}
        parentKey="bbb313a3-baf4-4147-ab5c-fba3cc8dc620"
        value="{{ moment().subtract(1,'years').format('YYYY') }}년 매출비중"
      />
      <Option
        id="7b5df"
        disabled={false}
        hidden={false}
        parentKey="bbb313a3-baf4-4147-ab5c-fba3cc8dc620"
        value="{{ moment().subtract(1,'years').format('YYYY') }}년 할인율"
      />
      <Option
        id="b0b08"
        disabled={false}
