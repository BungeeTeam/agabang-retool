with rt_tbl as (
    select
        ...
        case 
          when ord_id = 'AUTO01' then 'Cleave'
          when ord_id != 'AUTO01' and reg_tp = 'A' then 'Auto'
          else 'RequestByShop'
        end as ord_id,
