...
>
  ...
  <View id="33419" viewKey="View 1">
    <Text
      id="text11"
      value="**디즈니 RT 성과 분석(판매금액)**"
      verticalAlign="center"
    />
    <Text
      id="text10"
      value="**디즈니 RT 성과 분석(판매율)**"
      verticalAlign="center"
    />
    <Chart
      id="lineChart8"
    ...
    >
      <Series
        ...
        datasource="{{ disneyPerformanceAnalysis.data }}"
        ...
        xData="{{ disneyPerformanceAnalysis.data.rt_start_dt }}"
        xDataMode="source"
        yAxis="y"
        yData="{{ disneyPerformanceAnalysis.data.rt_rev }}"
        yDataMode="source"
        zData="[1, 2, 3, 4, 5]"
        zDataMode="manual"
      />
    ...
    >
      <Series
        ...
        xDataMode="source"
        yAxis="y"
        yData="{{ disneyPerformanceAnalysis.data.sales_ratio }}"
        yDataMode="source"
        zData="[1, 2, 3, 4, 5]"
        zDataMode="manual"
      />
