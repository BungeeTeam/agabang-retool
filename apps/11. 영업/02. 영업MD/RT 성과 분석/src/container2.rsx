...
>
  ...
  <View id="33419" viewKey="View 1">
    <Text
      id="text9"
      value="**에뜨와 RT 성과 분석(판매금액)**"
      verticalAlign="center"
    />
    <Text
      id="text7"
      value="**에뜨와 RT 성과 분석(판매율)**"
      verticalAlign="center"
    />
    <Chart
      id="lineChart5"
    ...
    >
      <Series
        ...
        datasource="{{ ettoiPerformanceAnalysis.data }}"
        ...
        xData="{{ ettoiPerformanceAnalysis.data.rt_start_dt }}"
        xDataMode="source"
        yAxis="y"
        yData="{{ ettoiPerformanceAnalysis.data.rt_rev }}"
        yDataMode="source"
        zData="[1, 2, 3, 4, 5]"
        zDataMode="manual"
      />
    ...
    >
      <Series
        ...
        xDataMode="source"
        yAxis="y"
        yData="{{ ettoiPerformanceAnalysis.data.sales_ratio }}"
        yDataMode="source"
        zData="[1, 2, 3, 4, 5]"
        zDataMode="manual"
      />
