<Frame
  ...
  padding="8px 12px"
  sticky={true}
  style={{ ordered: [{ "border-color": "rgba(224, 224, 224, 0)" }] }}
  type="header"
>
  <Navigation
    id="navigation1"
    ...
    captionByIndex=""
    data=""
    dbBlobId="f0938a49-c72d-453a-bf13-cd036c07d662"
    disabledByIndex=""
    hiddenByIndex=""
    highlightByIndex=""
    iconByIndex=""
    ...
    srcType="dbBlobId"
    style={{ ordered: [{ hoverBackground: "canvas" }] }}
    tooltipByIndex=""
  >
    <Option
      id="b48e7"
    ...
    <Option
      id="45bd3"
      hidden="{{ !current_user.groups.map(i=>i.name).includes('admin') }}"
  ...
  >
    <Option
      id="f90ab"
      appTarget="a9057c8c-46e2-11f0-a3f5-37c2be6fe191"
