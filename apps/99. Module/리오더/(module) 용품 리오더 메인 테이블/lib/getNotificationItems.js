...
const teamsCardData = {
    ...
    RETOOL_DASHBOARD_URL: notificationItems.length > 0 ? 
        (notificationItems[0].sty_cd.substring(0,2) === "07" 
            ? "https://agabang.cleave.work/app/reorder_seasonless_ettoi"
            : notificationItems[0].sty_cd.substring(0,2) === "79"
            ? "https://agabang.cleave.work/app/reorder_seasonless_disney"
            : "https://agabang.cleave.work/app/reorder_seasonless_agabang")
        : "https://agabang.cleave.work/app/reorder_seasonless_agabang", // 기본값
};
