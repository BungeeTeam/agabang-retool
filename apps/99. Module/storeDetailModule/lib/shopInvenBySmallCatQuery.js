...
const keys = ["year_nm", "season_nm", "it_nm", "it_gb_nm", "item_nm"]
const groupedArr = groupBySum(data, keys, sumKeys)
return groupedArr.sort((a, b) => a.it_nm.localeCompare(b.it_nm, "ko") && a.it_gb_nm.localeCompare(b.it_gb_nm, "ko") && a.item_nm.localeCompare(b.item_nm, "ko"))