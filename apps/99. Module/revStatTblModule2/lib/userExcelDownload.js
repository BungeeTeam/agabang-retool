// 담당자별 매출 현황 테이블 데이터를 엑셀 다운로드용으로 변환
// 금액 컬럼은 원단위로 변환 (백만원 * 1000000)
// salesByUser.value를 소스 데이터로 사용

utils.changeLocale("ko")

const data = salesByUser.value
...
// 파일명 생성
const fileName = `${tabs4.selectedLabel} 매출 현황(${moment().format('YYYY-MM-DD')})`
