            ...
            ordered: [
              {
                options: {
                  ordered: [
                    ...
                    {
                      fileName:
                        "{{ text40.value.slice(5,10) }}/{{ text51.value.slice(7) }}",
                    },
                  ],
                },
              },
            ...
            ordered: [
              {
                options: {
                  ordered: [
                    ...
                    {
                      fileName:
                        "{{ text40.value.slice(5,10) }}/{{ text63.value.slice(7) }}",
                    },
                  ],
                },
              },
            ...
            ordered: [
              {
                options: {
                  ordered: [
                    ...
                    {
                      fileName:
                        "{{ text40.value.slice(5,10) }}/{{ text50.value.slice(7) }}",
                    },
                  ],
                },
              },
